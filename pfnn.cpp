...
enum {
  GAMEPAD_BACK = SDLK_F1,
  GAMEPAD_START =SDLK_F1,
  GAMEPAD_A = 114,
  GAMEPAD_B = 115,
  GAMEPAD_X = 116,
  GAMEPAD_Y = 117,
  GAMEPAD_TRIGGER_L  = 118,
  GAMEPAD_TRIGGER_R  = 119,
  GAMEPAD_SHOULDER_L = 120,
  GAMEPAD_SHOULDER_R = 121,
  GAMEPAD_STICK_L_HORIZONTAL = SDLK_a,
  GAMEPAD_STICK_L_VERTICAL   = SDLK_w,
  GAMEPAD_STICK_R_HORIZONTAL = SDLK_s,
  GAMEPAD_STICK_R_VERTICAL   = SDLK_d
};
...
static void pre_render(int x, int y, int xMove, int yMove) {

  /* Update Camera */

  int x_move = x;//SDL_JoystickGetAxis(stick, GAMEPAD_STICK_R_HORIZONTAL);
  int y_move = y;//SDL_JoystickGetAxis(stick, GAMEPAD_STICK_R_VERTICAL);
  ...
  int x_vel = xMove;//-SDL_JoystickGetAxis(stick, GAMEPAD_STICK_L_HORIZONTAL);
  int y_vel = yMove;//-SDL_JoystickGetAxis(stick, GAMEPAD_STICK_L_VERTICAL);
    ...
    while (SDL_PollEvent(&event)) {
      ...
      if (event.type == SDL_KEYDOWN) {
        switch (event.key.keysym.sym) {
          ...
          case SDLK_LEFT: xCameraChange = 30000; break;
          case SDLK_RIGHT: xCameraChange = -30000; break;
          case SDLK_UP: yCameraChange = 30000; break;
          case SDLK_DOWN: yCameraChange = -30000; break;
          case SDLK_a: xMoveChange = 30000; break;
          case SDLK_d: xMoveChange = -30000; break;
          case SDLK_w: yMoveChange = 30000; break;
          case SDLK_s: yMoveChange = -30000; break;
        }
      }
    }

    pre_render(xCameraChange, yCameraChange, xMoveChange, yMoveChange);
    render();
    post_render();
